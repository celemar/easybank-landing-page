...
function App() {
  ...
  const leftItems = footerItems.slice(0, 3);
  const rightItems = footerItems.slice(3, 6);

  return (
    <div>
      <header>
        <div>
          <img src={logo} alt="easybank logo" className="logo" />
        </div>
        <button
          onClick={toggleMenu}
        ...
        <nav
          className={`primary-nav ${isMenuOpen ? "effect" : ""}`}
      ...
      <main>
        <section className="section1">
          <div className="image-wrapper">
            ...
            <img
              ...
              alt="image-mockups"
              className={`overlay-image ${isMenuOpen ? "backdrop" : ""}`}
            />
          </div>
        ...
        <section className="section2">
          ...
          <div className="features">
            <div>
              <img src="assets/icon-online.svg" alt="Online Banking Icon" />
              <h3 class="feature-heading">Online Banking</h3>
            ...
            <div>
              <img src="assets/icon-budgeting.svg" alt="Budgeting Icon" />
              <h3 class="feature-heading">Simple Budgeting</h3>
              <p class="feature-discription">
            ...
            <div>
              <img src="assets/icon-onboarding.svg" alt="Onboarding Icon" />
              <h3 class="feature-heading">Fast Onboarding</h3>
              <p class="feature-discription">
            ...
            <div>
              <img src="assets/icon-api.svg" alt="API Integration Icon" />
              <h3 class="feature-heading">Open API</h3>
              <p class="feature-discription">
        ...
        <article>
          ...
          <div className="articles-container">
            <div>
              <img src="assets/image-currency.jpg" alt="Currency exchange" />
            ...
            <div>
              <img src="assets/image-restaurant.jpg" alt="Restaurant dining" />
              <div className="article-details">
            ...
            <div>
              <img src="assets/image-plane.jpg" alt="Airplane travel" />
              <div className="article-details">
                <p class="article-author">By Wilson Hutton</p>
            ...
            <div>
              <img src="assets/image-confetti.jpg" alt="Confetti celebration" />
              <div className="article-details">
                <p class="article-author">By Claire Robinson</p>
      ...
      <footer>
        <img src={whitelogo} alt="easybank logo" className="footer-logo" />
        ...
        <button class="request-button">Request Invite</button>
        <div className="attribution">&copy; Easybank. All Rights Reserved</div>
      </footer>
    </div>
  );
}
